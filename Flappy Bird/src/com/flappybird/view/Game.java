package com.flappybird.view;//importing entire folder
...
import javax.swing.*;//importing everything in swing
...
public class Game extends JPanel implements ActionListener {
    ...
    public Game(String Name) //game takes parameters string name
    {
        this.Name = Name;
        proxyImage = new ProxyImage("/assets/background.png");//in proxyimage.java, it takes in string src that's why there's a source link here
